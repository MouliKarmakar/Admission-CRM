    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">
          Enter applicant details to begin admission process.
        </p>
      </div>
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-lg outline-none focus:ring-primary-500"
            />
          </div>
          <div>
          ...
          <div className="md:col-span-2 pt-4">
            <button
              type="submit"
              className="w-full bg-primary-600 text-white font-medium py-3 rounded-lg hover:bg-primary-700 transition"
            >
              Save Applicant
            </button>
          </div>
